        ...
        <aside className="w-64 min-h-screen bg-white border-r border-gray-200 flex flex-col sticky top-0">
            ...
            <div className="p-8 border-b border-green-200">
                <h2 className="text-2xl font-black tracking-tighter text-green-700 leading-tight">
                    PESO <span className="text-gray-500 font-light text-sm block mt-1">Juban Admin</span>
                </h2>
            </div>
            ...
            <div className="p-4 border-t border-green-200">
                <button onClick={logout} className="w-full flex items-center gap-4 px-4 py-3 text-gray-500 hover:text-red-500 hover:bg-red-50 rounded-xl font-bold text-xs uppercase tracking-widest transition-all">
                    <LogOut size={18} />
                    Log Out
                </button>
            </div>
